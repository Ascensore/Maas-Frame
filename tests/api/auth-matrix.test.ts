...
import * as videosImportUrlRoute from '@/app/api/projects/[projectId]/videos/import-url/route';
...
const ROUTE_CASES: readonly RouteCase[] = [
  ...
  {
    file: 'projects/[projectId]/videos/import-url/route.ts',
    module: videosImportUrlRoute,
    url: (f) => `/api/projects/${f.projectId}/videos/import-url`,
    params: (f) => ({ projectId: f.projectId }),
    body: {
  ...
  {
    file: 'versions/[versionId]/transcript/upload/route.ts',
    module: versionTranscriptUploadRoute,
    url: (f) => `/api/versions/${f.versionId}/transcript/upload`,
    params: (f) => ({ versionId: f.versionId }),
